...
from bora_workbench.tui.actions import compose_pi, compose_pi_remove, compose_pi_uninstall
...
_NOTE = (
    ...
    "npm, file, backup, and confirmation behavior begins after the workbench closes.",
)
...
class PiView(Section):
    ...
    def __init__(self, palette: Palette) -> None:
        """Create the hidden-until-opened pi section marked on provider linking."""
