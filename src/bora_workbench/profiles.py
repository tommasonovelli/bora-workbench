...
def load_catalog(root: Traversable | None = None) -> Catalog:
    ...
    from bora_workbench._profile_loading import load_catalog_from_root
...
def enforce_memory_gate(config: Config, hardware: HardwareInfo, *, force: bool) -> None:
    ...
    from bora_workbench._profile_matching import enforce_memory_gate_for_launch
...
def build_launch_plan(
    ...
    from bora_workbench._profile_matching import build_plan
