...
5. Do not submit it as v5 evidence or copy its proposal into packaged profiles; shared evidence
   requires a separate calibration/v5 run and the project's calibration contribution review.
"""
