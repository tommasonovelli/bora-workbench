...
record. Confirmation between two near-tied finalists lives in ``_calibration_confirm``.
"""
...
def select_fast(samples: tuple[Sample, ...]) -> Sample:
...
def select_balanced(samples: tuple[Sample, ...], fast: Sample) -> Sample:
...
def select_max_context(samples: tuple[Sample, ...]) -> Sample:
