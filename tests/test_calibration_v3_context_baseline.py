"""Offline orchestration test for one immutable GPU context baseline per v3 run."""
...
def test_all_modes_capture_one_run_scoped_gpu_baseline(tmp_path, monkeypatch) -> None:
    ...
    run_calibration_v3(cuda_target(("coding", "studio", "vstudio")), destination_root=tmp_path)
