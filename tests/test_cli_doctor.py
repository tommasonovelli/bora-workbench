...
def test_doctor_shows_calibrated_parameters_for_valid_records() -> None:
    ...
    cuda_line = diagnostics_cli._record_line("coding", RecordEvaluation("valid", 98304, 12, ()))
    cpu_line = diagnostics_cli._record_line("coding", RecordEvaluation("valid", 8192, None, ()))
