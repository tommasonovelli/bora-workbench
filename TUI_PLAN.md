...
- **Files.** `TUI_PLAN.md`, `src/bora_workbench/snapshot.py`,
  `src/bora_workbench/_cli_diagnostics.py`, `tests/test_snapshot.py`,
  `tests/test_cli_doctor.py`, `tests/test_cli.py`, `docs/commands.md`, `TUI.md`.
