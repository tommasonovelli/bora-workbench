...
[![Release](https://img.shields.io/github/v/release/tommasonovelli/bora-workbench.svg)](https://github.com/tommasonovelli/bora-workbench/releases/tag/v0.4.1)
...
Version **`0.4.1`** is distributed exclusively through GitHub Releases. Its distribution is
...
Install the exact `v0.4.1` wheel from the GitHub Release. The commands below download the release
